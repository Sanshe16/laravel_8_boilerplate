api['deleteHelpCenter'] = ajax_path + '/admin/helpcenter/:id';

$(function(){
    $('body').on('click', '.delete-helpcenter', function() {
        deleteHelpCenter($(this));
    });
    function deleteHelpCenter(data) {
        if ($(data).attr("data-id")) {
            let remove_id = data.data("id");
            let url = api["deleteHelpCenter"];
